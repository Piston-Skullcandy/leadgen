...
$fb_verify_token = 'Headphones2016bySkullCandy99'; //put in your facebook verify_token here
...
$wc_list_id = '5'; //here you need to put in the list ID for the whatcounts list you want the subscribers added to.  In this case, "115" is the ID of the "SKDYUS - TestAPI" list.
